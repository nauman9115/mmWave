    ...
    m_enbRrcSapProvider (0)
{
 ...
 // NS_LOG_INFO("SNN: Real RRC choosen"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
...
//  NS_LOG_INFO("SNN: In DoSetup"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
//		  <<"\t"<<Simulator::Now ().GetMicroSeconds());
...
MmWaveLteUeRrcProtocolReal::DoSendRrcConnectionRequest (LteRrcSap::RrcConnectionRequest msg)
{
  ...
  NS_LOG_INFO("SNN: ### RRC Connection Setup Request ###"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
		  <<"\t"<<Simulator::Now ().GetMicroSeconds());
...
MmWaveLteUeRrcProtocolReal::DoSendRrcConnectionSetupCompleted (LteRrcSap::RrcConnectionSetupCompleted msg)
{
  ...
  NS_LOG_INFO("SNN: ### RRC Connection Setup Completed ###"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
		  <<"\t"<<Simulator::Now ().GetMicroSeconds());
...
MmWaveLteUeRrcProtocolReal::DoSendRrcConnectionReconfigurationCompleted (LteRrcSap::RrcConnectionReconfigurationCompleted msg)
{
  ...
  // eNB we are currently attached to
	  NS_LOG_INFO("SNN: ### RRC Connection Reconfiguration Completed ###"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
			  <<"\t"<<Simulator::Now ().GetMicroSeconds());
  m_rnti = m_rrc->GetRnti ();
  SetEnbRrcSapProvider ();
  ...
  transmitPdcpSduParameters.rnti = m_rnti;
  transmitPdcpSduParameters.lcid = 1;
  NS_LOG_INFO("Tx RRC Connection reconf completed"<<"\t"<<Simulator::Now ()<<"\t");
  m_setupParameters.srb1SapProvider->TransmitPdcpSdu (transmitPdcpSduParameters);
}
...
MmWaveLteEnbRrcProtocolReal::DoSetupUe (uint16_t rnti, LteEnbRrcSapUser::SetupUeParameters params)
{
  ...
  //NS_LOG_INFO("SNN: In DoSetupUe"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
	//	  <<"\t"<<Simulator::Now ().GetMicroSeconds());
...
MmWaveLteEnbRrcProtocolReal::DoSendRrcConnectionSetup (uint16_t rnti, LteRrcSap::RrcConnectionSetup msg)
{
  ...
  NS_LOG_INFO("SNN: ### Send RRC Connection Setup ###"<<"\t"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
		  <<"\t"<<Simulator::Now ().GetMicroSeconds());
...
MmWaveLteEnbRrcProtocolReal::DoSendRrcConnectionReconfiguration (uint16_t rnti, LteRrcSap::RrcConnectionReconfiguration msg)
{
  ...
  NS_LOG_INFO("SNN: ### Send RRC Connection Reconfiguration ###"<<"\t"<<Simulator::Now ()<<"\t"<<Simulator::Now ().GetMilliSeconds()
		  <<"\t"<<Simulator::Now ().GetMicroSeconds());
